...
class OpenAIServiceProduct {
  ...
  async embedProducts(products: { name: string; price: string; imageUrl: string }[]): Promise<ProductEmbedding[]> {
...
export const analyzeProduct = async (
  req: Request,
  res: Response & { locals: { scrapedData: ScrapedDataProduct; analysis: ProductEmbedding[] } },
  next: NextFunction
): Promise<void> => {
  try {
